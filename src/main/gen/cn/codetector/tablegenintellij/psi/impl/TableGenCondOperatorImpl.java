...
public class TableGenCondOperatorImpl extends ASTWrapperPsiElement implements TableGenCondOperator {

  public TableGenCondOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TableGenVisitor visitor) {
    visitor.visitCondOperator(this);
  }
