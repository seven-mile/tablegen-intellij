...
public class TableGenPreprocessorDirectiveImpl extends ASTWrapperPsiElement implements TableGenPreprocessorDirective {

  public TableGenPreprocessorDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
